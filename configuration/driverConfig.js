import wd from 'wd';
import { iphoneDevice, iphoneSimulator, androidGalaxyS8, androidEmulator } from './capabilityConfig';
...
const isIOS = capability.platformName.toLowerCase() === 'ios';
const isAndroid = capability.platformName.toLowerCase() === 'android';

beforeAll(async () => {
  await driver.init(capability);
});

export { driver, asserters, capability, isIOS, isAndroid, touchAction };
